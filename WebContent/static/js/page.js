...
clipInit=function (){
	...
	str+="<a class='disbled' id='lastPage' onclick='LastPage()'><</a>";
	str+="<div id='pageU' class='fl'>";
	if(liTab<=pageCon){
		for(var i=1;i<=liTab;i++){
			str+="<a id='clip"+i+"' onclick='pageInt(&#039;clip"+i+"&#039;,&#039;"+liTab+"&#039;,&#039;"+medCur+"&#039;)'>"+i+"</a>";
		}
	}else{
		for(var i=1;i<=pageCon;i++){
			str+="<a id='clip"+i+"' onclick='pageInt(&#039;clip"+i+"&#039;,&#039;"+pageCon+"&#039;,&#039;"+medCur+"&#039;)'>"+i+"</a>";
		}
	}
	str+="<a class='clear'></a>";
	str+="</div>";
	str+="<a class='BORDER' id='nextPage' onclick='NextPage()'>></a>";
